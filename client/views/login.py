...
"background-color: #0A5EF2;")
    ...
    def retranslateUi(self, loginForm):
        ...
        self.label.setText(QCoreApplication.translate("loginForm", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">LOGIN CHIDORI</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("loginForm", u"USERNAME", None))
        self.joinButton.setText(QCoreApplication.translate("loginForm", u"ENTRAR", None))
    # retranslateUi
